    ...
    <nav ref={navRef} className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-6 md:px-12 transition-colors duration-300 mt-8 lg:mt-0">
      ...
      <div className="flex items-center gap-8">
        <div className="hidden md:flex items-center gap-8 text-xs font-bold tracking-widest uppercase text-white/80 nav-text">
            ...
            <Link href="#" className="hover:opacity-70 transition-opacity">What We do</Link>
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <Link href="/" className="text-2xl font-serif italic text-white flex items-center gap-2 nav-text">
            {"{TWG}"}
        </Link>
      </div>
